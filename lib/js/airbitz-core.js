...
(function(root) {
   ...
   */
  Airbitz.core.createSpendRequest = function(wallet, toAddress, amountSatoshi, amountFiat, options) {
    Airbitz._bridge.createSpendRequest(wallet, toAddress, amountSatoshi, amountFiat, options);
  };
   ...
   * @param {amountFiat} amountFiat - not required, but the fiat value at the time of the request
   */
  Airbitz.core.createSpendRequest2 = function(wallet, toAddress, amountSatoshi, toAddress2, amountSatoshi2, amountFiat, options) {
    Airbitz._bridge.createSpendRequest2(wallet, toAddress, amountSatoshi, toAddress2, amountSatoshi2, amountFiat, options);
  };
   ...
   * @param {amountFiat} amountFiat - not required, but the fiat value at the time of the request
   */
  Airbitz.core.requestSign = function(wallet, toAddress, amountSatoshi, amountFiat, options) {
    Airbitz._bridge.requestSign(wallet, toAddress, amountSatoshi, amountFiat, options);
  };
