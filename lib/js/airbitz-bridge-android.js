...
_bridge = function() {
  ...
  return {
    ...
    createSpendRequest: function(wallet, toAddress, amountSatoshi, amountFiat, options) {
      ...
      _native.createSpendRequest(cbid, wallet.id, toAddress, amountSatoshi, amountFiat,
    ...
    createSpendRequest2: function(wallet, toAddress, amountSatoshi, toAddress2, amountSatoshi2, amountFiat, options) {
      ...
      _native.createSpendRequest2(cbid, wallet.id, toAddress, amountSatoshi, toAddress2, amountSatoshi2, amountFiat,
          options.label || '', options.category || '', options.notes || '', options.bizId);
    },
    ...
    getAffiliateInfo: function() {
      return _native.getAffiliateInfo();
    },
