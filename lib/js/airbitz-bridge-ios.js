...
function _bridge() {
  ...
  return {
    ...
    bitidAddress: function(options) {
      var cbid = createCallback(options);
      _native('bitidAddress', cbid, options);
    },

    bitidSignature: function(options) {
      var cbid = createCallback(options);
      _native('bitidSignature', cbid, options);
    },
    ...
    finalizeRequest: function(wallet, requestId) {
      var options = {'id': wallet.id, 'reqeustId': requestId};
      var cbid = createCallback(options);
